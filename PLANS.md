...
| M1 ADR Ratification | **◑** | 51 ADRs (não 24); recontado 2026-09-12 (AF-06) — era "32" desde 2026-07, ficou stale conforme a árvore cresceu (ADR-0030/0031 adicionados 2026-07; até ADR-0049 em 2026-09-08; ADR-0050 em 2026-09-12, WP-J1-11; ADR-0051 em 2026-09-12, WP-J1-09). Ainda há ADRs "Proposed". Contínuo. || M2 BPMN/DMN Regeneration | **◑** | BPMN/DMN existem + `validate-artifacts` verde; **MAS contratos ainda DRAFT — o gap<5% e a validação por SME NÃO foram feitos** (G2-bloqueado). |
