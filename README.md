...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/coverage-79K_LOC-blue" alt="~79K LOC">
...
| Linhas de código (src) | ~79K (`find src -name '*.py' \| xargs wc -l` -> 79462, 2026-09-03 pós-merge com `main` `0db53dd`) |
