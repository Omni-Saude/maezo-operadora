...
variable "image_tag" {
  ...
  EOT
  type        = string
  default     = "8b014a60" # main de 20/09/2026 (merge de #440) — promovida a dev por #445 (21/09); antes c745fd94 09/09, 40dc6d4 27/08
}
...
variable "webhook_receiver_image_tag" {
  ...
  default = "8b014a60" # main de 20/09/2026 (#440) promovida a dev por #445 (21/09); response-v3 de 13/09 (`e86c0f89`) que o receptor ja rodava
}
...
variable "canal_teste_image_tag" {
  ...
  # DESCREVE O QUE RODA. Promover e' um commit que muda este numero, nao um `-var` que so' existe
  # no terminal de quem aplicou.
  default = "8b014a60" # main de 20/09/2026 (#440) promovida a dev por #445 (21/09); pagina de escalonamento de 13/09 (`e86c0f89`)
}
