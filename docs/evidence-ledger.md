...
| T1.10 | 2026-07-17 | audit-persistence-engineer (R2) | — | a1f96d0e9883932300a8e1f5e2f36380579991f8 | gateway/audit_postgres.py:167,202,220,333 (PostgresAuditSink.emit fail-closed + advisory lock, verify_chain); gateway/audit.py:46,98-99,104 (GENESIS_PREV_HASH sentinel, tenant_id/agent_version/dmn_versions non-null); migrations/env.py SET-search_path + missing-commit fixes (discovered verifying against real Postgres); tests/unit/gateway/test_audit_postgres.py:422 kill-test (real docker-compose postgres, 200 records, SIGKILL after 20 confirmed, restart, 0 lost, chain verifies); docs/adr/0027-audit-transport-postgres-first.md | sha256:0f1cab9c1deae8ac6a4f69916f4c591148fd1c1dde15c2ad0696db89085a7d76 | implemented — unverified |
