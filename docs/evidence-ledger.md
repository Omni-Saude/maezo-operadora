...
| T1.3 | 2026-07-16 | process-engine-specialist (R2) | — | cb5593f070b36b34c9767b9ec154361f8312157e | engine_deploy.py:151,166,205,253,314 (EngineDeployClient.deploy/list_deployments, DeploymentOutcome); cli.py:1-153; Makefile:2,46; live docker-compose cibseven:2.1.0 run — 69/70 artifacts (15/16 BPMN + 54/54 DMN) deploy + idempotent re-run (0 new); SP-OP-AUTH-001_Autorizacao_Previa.bpmn rejected by engine (ENGINE-09005, GW_DecisaoAuditor) | sha256:0e20eb0f13e7b4030cdd93fe03d02d1844b9ed77724b76375b6da2c3c112b55e | implemented — partially blocked(artifact defects) |
