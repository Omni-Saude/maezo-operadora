...
| T1.8 | 2026-07-16 | policy-guardian (R1) | — | 1a86295e437303620f48245d5f7ff8cb25d69482 | src/maezo/gateway/pep.py:71 (HARD_ACTIONS frozen 5); src/maezo/gateway/pep.py:287 (load_matrix); src/maezo/gateway/pep.py:336 (build_pep fail-closed factory); src/maezo/agents/__init__.py:36-104 (spec-dir resolution order incl. installed-wheel fallback, REVISE-1); tests/unit/gateway/test_pep_policy_unification.py (ADR-0025 §4, implementation phase) | sha256:915dd4e4c4137768fdb02cff3ebbeb6b57ed891e80160fd37d646057a541d0e0 | implemented — unverified (REVISE-1 addressed; probe-5 re-check pending) |
| T1.9 | 2026-07-17 | policy-guardian (R1) | — | ac1fd4aff7bc656474952e21b4ca8c8f45aa2700 | src/maezo/tools/workers/ceilings.py:170-183 (within_l2_ceiling; ceiling-0→False fail-closed); src/maezo/tools/workers/reembolso.py:250-255 (dentro_teto_l2 COMPUTED via resolver — old :227-230 manufacture deleted, defect B3); src/maezo/tools/workers/auth.py:82-96 (teto_ok from valor_estimado_brl; absent/None/non-numeric→False, hardened divergence from v1 `_as_float`); src/maezo/tools/workers/pagto.py:143-153 (high_value_payment.threshold_brl; R$100k literal dropped); tests/unit/sec/test_dentro_teto_source.py:150,186 (AST ORIGINATE-vs-PROPAGATE architecture test — bites pre-fix, clean post-fix); tests/unit/tools/workers/test_ceilings.py + test_reembolso.py::test_within_table_max_value_zero_routes_analise_humana (acceptance). Base: stacked on t1.8-pep-policy-unification. D-07 max_value_brl remains blocked(external: diretoria AMH); design works with 0. | sha256:dcb4bce731e7db28c8bc10dc997a82ba8ed12176eedc957acba95fa27ad6a9f1 | implemented — unverified (pending R1 adversarial verification) |
