...
**Fase:** 3 (PATHFINDER — classe nova: cadeia de custodia / selagem de evidencia) · **Wave:** W-A (quadrupla SOZINHA, igual CONTAS em Phase 2) · **BPMN (a autorar contra este contrato):** `src/maezo/processes/bpmn/SP-OP-FRAUDE-001_Investigacao_Fraude.bpmn`
