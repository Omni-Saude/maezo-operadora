...
Auditoria dos 13 modulos `tests/**/test_*_live*.py` em `main` `2e46145`: censo de marcador, env,
...
zero skip, stack frio). O que fica abaixo e o que NAO pode ser fechado do lado dos testes.
