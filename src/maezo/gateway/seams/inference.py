...
Satisfies the surface every graph uses of `runtime/inference.py:544`'s `InferenceProvider`:
...
`agent_id`/`tenant_id` are metering correlation ids (`runtime/inference.py:630-640`: "purely
