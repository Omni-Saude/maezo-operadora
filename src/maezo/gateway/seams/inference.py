...
Satisfies the surface every graph uses of `runtime/inference/__init__.py::InferenceProvider`:
...
`agent_id`/`tenant_id` are metering correlation ids
(`runtime/inference/__init__.py::InferenceProvider.generate`: "purely
