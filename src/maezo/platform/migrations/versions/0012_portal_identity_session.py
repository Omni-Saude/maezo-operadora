...
Revision 0012 deliberately revises the actual 0010 baseline. Concurrent human outbox 0011
requires 0012 to revise 0011 before combined publication, independently tested on PostgreSQL.
