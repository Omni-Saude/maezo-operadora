...
final class AuthModels {
  ...
  static final Map<String,String> SHAPES=Map.ofEntries(
    ...
    Map.entry("intent","intent_ref:r intake_or_response_ref:r command_id:r actor:@actor admitted_digest:h operation:auth.start|auth.documents.respond state:committed admitted_at:t"),
