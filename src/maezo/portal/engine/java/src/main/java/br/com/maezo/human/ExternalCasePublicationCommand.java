...
public final class ExternalCasePublicationCommand implements Command<ExternalCasePublicationCommand.Result> {
  ...
  @Override public Result execute(CommandContext context){
    ...
    var db=new ExternalCaseStore(context,verified.configuration.scope(),verified.admission.statementTimeoutSeconds(),verified.configuration.engineSchema(),verified.configuration.nativeSchema());
