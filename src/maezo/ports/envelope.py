...
on 2026-08-05 — identity/consent value semantics remain MZO-020's DPO-gated scope. DL-0042
discharged the gate on opaque refs, not on a prefix vocabulary: this module still defines NO
parsing, NO prefix vocabulary, NO regex and NO structural validation for
