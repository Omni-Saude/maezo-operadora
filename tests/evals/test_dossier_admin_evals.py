...
def test_dataset_counts_match_ratified_design() -> None:
    ...
    # case proves.
    # R6 acrescenta um JOURNEY-01 por agente, alem de todos os goldens Fleet acima.
    # Uniao medida: Carolina 9, Beatriz 7, Gustavo 10; nenhum caso removido.
    assert len(CAROLINA_CASES) == 9
    assert len(BEATRIZ_CASES) == 7
    assert len(GUSTAVO_CASES) == 10
