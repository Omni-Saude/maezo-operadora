...
def test_removing_whatsapp_verify_token_from_the_deployment_states_the_boot_reason(
    ...
    # O ECS agora declara o mesmo nome. Esta mutacao visa o receptor Helm:
    # uma declaracao ECS nao entrega a variavel ao pod. Remova apenas esse
    # segundo declarante para preservar a prova RED e o restante do inventario.
    declared = extract_declared_from_helm(rendered) + [
