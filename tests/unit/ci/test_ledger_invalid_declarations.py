...
@pytest.mark.xfail(
    ...
    reason=(
        ...
        "main permanecer main. expected-fail-until=2027-02-09. RENOVACAO — DECISAO DO DONO "
        "2026-09-20: a obrigacao do catalogo segue viva e a saida depende do programa D7 "
        "secured-startup (#438 Slice A pousou 2026-09-20); renovar alinha as TRES cercas "
        "same-date (desvios Q-2/Q-10, ciclo de vida, catalogo D7) num UNICO momento de revisao do "
        "dono, evitando que as tres fiquem vermelhas no mesmo dia (memo MEMOS 2026-09-19, Opcao "
        "B). Checkpoint de revisao sugerido: 2026-12-15. Criterio de saida MENSURAVEL: um "
