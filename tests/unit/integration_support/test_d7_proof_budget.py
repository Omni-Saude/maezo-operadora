...
# WP-C078 port adaptation: same machine-local packet guard as test_d7_startup_observation; the
# guarded import of `m` below must stay after this check so an absent packet skips this module
# cleanly at collection instead of erroring on the transitive import.
if not PACKET.is_dir():
    pytest.skip(f"D7 custody packet absent: {PACKET}", allow_module_level=True)

from tests.unit.integration_support.test_d7_startup_observation import m  # noqa: E402
