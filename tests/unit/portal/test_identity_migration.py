...
def test_0012_is_the_unique_head_of_a_linear_chain() -> None:
    ...
    operator believes it applied the other. Propagated from 0010 to the real 0012 head;
    ...
    assert heads == {"0012"}, f"expected 0012 to be the sole head, got {heads}"
