...
| `python -m tools.staff_materials.approver root-keygen --out D` | **aprovador** | **máquina dele** | par Ed25519 `installation-root`; a privada não sai de lá |
...
- `engine/` — chave e certificado do listener mTLS, CA dos clientes (truststore do Tomcat), chave
  `native_result`, chave de continuidade de 32 bytes.
